...
const user_acc = require("./user_acc");
const investment = require("./investment"); //const account = require("./account");
...
service.use(user_acc.router);
// Import API path mappings from account.js
service.use(investment.router); //service.use(account.router);
